...
bot.on('guildMemberAdd', member => {
    ...
    member.guild.channels.get('464486903354228776').send('""'+ member.user.username +'"", Hazretleri Hoşgeldiniz! Bizde Tam Sizi Bekliyorduk'); //Sunucuya katılan kişiye hoşgeldin mesajı
});

//Sunucudan ayrılan kişiler
bot.on('guildMemberRemove', member => {
  member.guild.channels.get('464486903354228776').send('""'+ member.user.username +'"", Sunucudan Ayrıldı. Yürü Git Lağnnn'); //Sunucudan ayrılan kişiye mesaj
});
//GİRİŞ
